...
- [inkbridge](https://github.com/ClinShaiju/inkbridge) - (Made for rMPP) A program for Windows feeding touch and pressure-sensitive pen inputs to OpenTabletDriver (OTD) over USB cable.
